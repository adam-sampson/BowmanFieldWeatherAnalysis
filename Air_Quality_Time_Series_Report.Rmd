...
#   Choose two years to compare. Also, this will average the measurements accross all sites.
    ...
    par(mfrow = c(2, 1))
    plot(ozone$Date , ozone$avg.measurement , type = "p", pch = 20, xlim = range(ozone$Date, na.rm = TRUE), 
    ...
    #lines(as.vector( ozone[1:(nrow(ozone) - 2) ,"Date"] ) ,  rollmean(ozone$avg.measurement, k = 2), type="o", pch=22, lty=2, col="blue")  
...
```{r  fig.align='center' ,echo=FALSE}
    ...
    seasonplot(pm2.5_ts, s = 12,   main="Seasonal plot: PM 2.5",
                year.labels=TRUE, year.labels.left=TRUE, ylab = expression(PM[2.5] * " (" * mu * g/m^3 * ")"), col=1:20, pch=1)
