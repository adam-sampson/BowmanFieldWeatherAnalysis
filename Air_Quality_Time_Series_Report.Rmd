...
#   Choose two years to compare. Also, this will average the measurements accross all sites.
    ...
    #par(mfrow = c(2, 1))
    plot(ozone$Date , ozone$avg.measurement , type = "p", xlim = range(ozone$Date, na.rm = TRUE), 
    ...
    legend("topright", legend=c("EPA guideline ", "Moving Average 60 days"),
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
        ...
        title(expression(PM[2.5] * " vs. Mean Wind Speed (1990 - 2017)"))
        abline(lm(comb_data[comb_data$AQS_PARAMETER_DESC =="PM2.5 - Local Conditions", "Measurement"] ~
