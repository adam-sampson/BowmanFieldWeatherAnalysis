...
packages <- c("tidyverse", "lubridate", "tibbletime", "rlang", "dygraphs", "forecast", "zoo")
...
Now we have regularly spaced hourly data! Ready to move on to perform analysis.
