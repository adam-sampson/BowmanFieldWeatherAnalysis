...
```{r echo=TRUE, message=FALSE, warning=FALSE, include= TRUE}
        ...
        #  plot(comb_data[comb_data$AQS_PARAMETER_DESC =="Ozone", "mean.temp"], 
        #      comb_data[comb_data$AQS_PARAMETER_DESC =="Ozone", "Measurement"],
        #      xlab = "Mean Temp. (F)", ylab = "Ozone (ppm)")
        # title("Ozone vs. Mean Temp. (1990 - 2017)")
        # abline(lm(comb_data[comb_data$AQS_PARAMETER_DESC =="Ozone", "Measurement"] ~
        #           comb_data[comb_data$AQS_PARAMETER_DESC =="Ozone", "mean.temp"]), col = "red")
        # print(cor(comb_data[comb_data$AQS_PARAMETER_DESC =="Ozone", "mean.temp"], 
        #      comb_data[comb_data$AQS_PARAMETER_DESC =="Ozone", "Measurement"]))
        # 
        # plot(comb_data[comb_data$AQS_PARAMETER_DESC =="Sulfur dioxide", "mean.temp"], 
        #      comb_data[comb_data$AQS_PARAMETER_DESC =="Sulfur dioxide", "Measurement"],
        #      xlab = "Mean Temp. (F)", ylab = "Sulfur Dioxide (ppm)")
        # title("Sulfur Dioxide vs. Mean Temp. (1990 - 2017)")
        # abline(lm(comb_data[comb_data$AQS_PARAMETER_DESC =="Sulfur dioxide", "Measurement"] ~
        #           comb_data[comb_data$AQS_PARAMETER_DESC =="Sulfur dioxide", "mean.temp"]), col = "red")
        # print(cor(comb_data[comb_data$AQS_PARAMETER_DESC =="Sulfur dioxide", "mean.temp"], 
        #      comb_data[comb_data$AQS_PARAMETER_DESC =="Sulfur dioxide", "Measurement"]))
