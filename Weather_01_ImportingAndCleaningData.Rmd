---
title: "Bowman Field Weather_01_Importing and Cleaning Data"
output:
  html_document:
    fig_width: 8
    df_print: paged
...
clean_ncdc_df <- function(in.df) {
  # Replace CLG values of 722 with Inf because of documentation
  ...
  # Replace DIR values of 990 with NA. This means Variable...but we can't analyze variable.
  # Unsure why some values are over 360. Can either use value %% 360 or can turn into NA.
  # Using NA because unsure what the meaning is.
  in.df[(is.na(in.df[,"DIR"])) | (in.df[,"DIR"] > "360"),"DIR"] <- NA
...
Now we have regularly spaced hourly data! 

## Save Data for future analysis

```{r}
save(bf.tt, file = "BowmanField_Weather.RData")
save(lex.tt, file = "LexingtonAirport_Weather.RData")
gc(verbose = TRUE)
```
